...
#  Settings
# ==========================================================================
env.project_name = 'geo_json_with_django'
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.geo_json_with_django.com']
    env.dotenv_path = '/home/ubuntu/dev/geo_json_with_django/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.geo_json_with_django.com']
    env.dotenv_path = '/home/ubuntu/qa/geo_json_with_django/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.geo_json_with_django.com']
    env.dotenv_path = '/home/ubuntu/prod/geo_json_with_django/.env'
    env.config_setter = fab.run

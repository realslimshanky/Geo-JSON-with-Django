"""Django settings for Geo JSON with Django project.
...
APPS_DIR = ROOT_DIR.path('geo_json_with_django')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'geo_json_with_django.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'geo_json_with_django.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'geo_json_with_django.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='Geo JSON with Django')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='Geo JSON with Django')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'geo_json_with_django.urls'
...
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[Geo JSON with Django] ')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'geo_json_with_django.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'geo_json_with_django.base.views.csrf_failure'
...
def get_release():
    import geo_json_with_django
    import os
    import raven
    release = geo_json_with_django.__version__
    try:
